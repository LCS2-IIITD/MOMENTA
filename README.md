...
<ol>
    <li><strong><u>HarMeme-V0:</u></strong> <strong><i>CAUTION! OBSOLETE FOR HARM-P "Harmfulness" - Contains duplicates in Harm-P.</i></strong> Thanks to <a href="https://github.com/mingshanhee">mingshanhee</a> and <a href="https://github.com/uprihtness">uprihtness</a> for pointing out the discrepancies. See the upgraded version (V1) below for the deduplicated version of Harm-P/C (Harmfulness) data. HarMeme-V0 content (including <i>Target</i> data for HarMeme-V0) can be accessed via the following links:</li>
<ul>
